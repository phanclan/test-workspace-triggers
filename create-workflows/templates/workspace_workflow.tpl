  ...
  hello_world_job:
    ...
    steps:
      ...
      - name: Terraform Format Init Validate Composite Action
        id: foo
        uses: ./.github/actions/terraform-workflow@v1.1 # actions/hello-world-composite-run-steps-action@v1
#        uses: actions/hello-world-composite-run-steps-action@v1
        with:
          working-directory: '${working_directory}'
          who-to-greet: 'Mona the Octocats'
      - run: echo random-number $${{ steps.foo.outputs.fmt }} $${{ steps.foo.outputs.tf_init }} $${{ steps.foo.outputs.random-number }}
      - name: Terraform Plan
        id: plan
